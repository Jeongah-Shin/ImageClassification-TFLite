...
class ClassifierDrawView : View {
  ...
  fun setDrawPoint(
    ...
    var tempX: Float = point[0][0] /  ratio / mRatioX
    var tempY: Float = point[1][0] / ratio / mRatioY
  ...
  override fun onMeasure(
    ...
    Log.i("Pose - mRatioMeasure", "mRatioX : $mRatioX = mImgWidth : $mImgWidth / mWidth :$mWidth")
    Log.i("Pose - mRatioMeasure", "mRatioY : $mRatioY = mImgHeight : $mImgHeight / mHeight :$mHeight")
  }
}
