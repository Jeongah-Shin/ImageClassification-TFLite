...
import com.jeongari.mask_or_not.ClassifierDrawView
import com.jeongari.mask_or_not.ImageClassifier
import com.jeongari.mask_or_not.ImageClassifierFloatException
import com.jeongari.mask_or_not.R
...
class Camera2BasicFragment : Fragment(), ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private var tvState : ImageView?= null

    private var imageClassifier : ImageClassifier ?= null
    private var runImageClassifier : Boolean = false
    private var classifierDrawView : ClassifierDrawView ?= null
    ...
    private fun showState(text: String) {
        ...
        activity?.runOnUiThread {
            tvResult?.text = "mask = " + (imageClassifier!!.probMask!!.times(100)).toString() + "\n" +  "non-mask = " + (imageClassifier!!.probNonMask!!.times(100)).toString()
        }
    }
    ...
    override fun onViewCreated(
        ...
        classifierDrawView = view.findViewById(R.id.classifierDrawView)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        try {
            imageClassifier = ImageClassifierFloatException.create(activity!!)
            if (classifierDrawView != null)
                classifierDrawView!!.setImgSize(imageClassifier!!.imageSizeX, imageClassifier!!.imageSizeY)
        } catch (e: IOException) {
            Log.e(TAG, "Failed to initialize an finger pose classifier.", e)
        }
    }
        ...
        try {
            for (cameraId in manager.cameraIdList) {
                ...
                if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
                    ...
                    classifierDrawView!!.setAspectRatio(previewSize!!.width, previewSize!!.height)
                } else {
                    layoutFrame!!.setAspectRatio(previewSize!!.height, previewSize!!.width)
                    textureView!!.setAspectRatio(previewSize!!.height, previewSize!!.width)
                    classifierDrawView!!.setAspectRatio(previewSize!!.height, previewSize!!.width)
                }
...
//                .show(childFragmentManager, FRAGMENT_DIALOG)
    ...
    private fun classifyFpe(){
        if (imageClassifier == null || activity == null || cameraDevice == null) {
//            showState("Uninitialized Classifier or invalid context.", null)
            return
        }
        val bitmap = textureView!!.getBitmap(imageClassifier!!.imageSizeX, imageClassifier!!.imageSizeY)
        val textToShow = imageClassifier!!.classifyFrame(bitmap)

        showState("")

        bitmap.recycle()
//        classifierDrawView!!.setDrawPoint(imageClassifier!!.mPrintPointArray!!, 0.5f)

        classifierDrawView?.invalidate()
    }
